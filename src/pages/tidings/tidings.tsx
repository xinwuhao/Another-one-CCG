...
const Tidings = () => {
    ...
    let [num, setNum] = useState<boolean>(false)
        ...
        <div style={{ backgroundColor: '#E6E6FA', padding: 20 }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    {/* 表情 */}
                    <div style={{ marginRight: 20 }} onClick={ON}>
                ...
                <div>
                    {num == true ? <div style={{ overflowY: 'scroll', width: '100%', display: 'flex', flexWrap: 'wrap', height: 200, paddingTop: 20 }}>
                        {emojiImg && emojiImg.map((item: any, index: number) => {
                            return (
                                <div key={index}>
                                    <div style={{ padding: 20 }} onClick={() => { imgbtn(item) }}>{item}</div>
                                </div>
                            )
                        })}
                    </div> : <div></div>}
