...
const Customer = () => {
    let list = useSelector((state: any) => state.user.topics)
    ...
    return (
        <div style={{ backgroundColor: '#fff', width: '100%', height: '100%', padding: 20 }}>
                        ...
                        <Form name="validate_other" onFinish={handleOk} form={form} preserve={false}>
                            ...
                            >
                                <Upload
                                    ...
                                    <div >{estimate == 2 && url1 == '' ? <img src={`${img}`} style={{ height: 100, width: 100 }} /> : <div></div>}</div>
                                </Upload>
                                <Modal
            ...
            <div>
                <img src="https://img2.baidu.com/it/u=2740682934,631914803&fm=26&fmt=auto&gp=0.jpg" alt="" />
                    ...
                    <Column
                        ...
                        render={(text: any, record: any) => (
                            <Image
                                width={80}
                                height={80}
                                src={record.username == '' ? 'https://img2.baidu.com/it/u=2740682934,631914803&fm=26&fmt=auto&gp=0.jpg' : record.username}
                            />
                        )}
                    />
                    <Column title="用户名称" dataIndex="username" key="username" />
                    <Column title="用户电话" dataIndex="mobile" key="mobile" />
