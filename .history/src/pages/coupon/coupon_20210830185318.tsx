            ...
            <div style={{ backgroundColor: '#fff', width: '100%', height: '100%', padding: 20 }}>
                <div>
                    ...
                    <Modal
                        ...
                        destroyOnClose={true}>
                        <div>
                            <Form name="validate_other" onFinish={handleOk} form={form} preserve={false}  wrapperCol={{ offset: 2 }}>
                                <Form.Item initialValue={content} name="content" label="优惠券名称">
                                    <Input />
                                </Form.Item>
                                <Form.Item initialValue={content} name="content" label="使用门槛">
                                    <Input />
                                </Form.Item>
                                <Form.Item initialValue={content} name="content" label="优惠券金额">
                                    <Input />
                                </Form.Item>
                                <Form.Item initialValue={content} name="content" label="开始时间">
                                    <Input />
                                </Form.Item>
                                <Form.Item initialValue={content} name="content" label="结束时间">
                                    <Input />
                                </Form.Item>
                                <Form.Item initialValue={content} name="content" label="发放数量">
                                    <Input />
                                </Form.Item>
                            </Form>
                        </div>
                ...
                <div>
                    <Table dataSource={topics.data} rowKey='_id'>
                        <Column title="优惠券名称" dataIndex="content" key="content" />
                        <Column title="开始时间" dataIndex="content" key="content" />
                        <Column title="结束时间" dataIndex="content" key="content" />
                        <Column title="优惠金额" dataIndex="content" key="content" />
                        <Column title="使用门槛" dataIndex="content" key="content" />
                        <Column title="发放数量" dataIndex="content" key="content" />
                        <Column
                            title="是否禁用"
                            dataIndex="isShow"
                            key="isShow"
