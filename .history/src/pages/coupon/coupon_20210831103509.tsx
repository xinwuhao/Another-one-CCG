...
const Coupon = () => {
    ...
    let btn = (item: any) => {
        ...
        form.setFieldsValue({ number: item.number })
        form.setFieldsValue({ amount: item.amount.getTime() })
        form.setFieldsValue({ end_time: item.end_time })
        // form.setFieldsValue({ start_time: item.start_time })
