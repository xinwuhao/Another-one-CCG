            ...
            <div style={{ backgroundColor: '#fff', width: '100%', height: '100%', padding: 20 }}>
                ...
                <div>
                    <Table dataSource={topics.data} rowKey='_id'>
                        <Column title="优惠券名称" dataIndex="name" key="content" />
                        <Column title="开始时间" dataIndex={`${dayjs('start_time').format('{YYYY} MM-DDTHH:mm:ss SSS')}`} key="content" />
                        <Column title="结束时间" dataIndex="end_time" key="content" />
                        <Column title="优惠金额" dataIndex="threshold" key="content" />
                        <Column title="使用门槛" dataIndex="amount" key="content" />
                        <Column title="发放数量" dataIndex="number" key="content" />
                        <Column
                            title="是否禁用"
                            dataIndex="isShow"
                            key="isShow"
