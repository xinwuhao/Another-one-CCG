        ...
        <Header className="site-layout-background" style={{ padding: '0 20px', background: '#fff' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0px 10px', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <iframe width="350" height="25" frameBorder="0" scrolling="no" src="https://i.tianqi.com/?c=code&id=40"></iframe>
              <div style={{ margin: '0px 10px' }}>
                <Avatar icon={<UserOutlined />} />
              </div>
              <div>admin</div>
              <div style={{ margin: '0px 10px' }}>文字切换</div>
            </div>
          </div>
        </Header>
        <Content
