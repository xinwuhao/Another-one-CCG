...
const Layouts = (props: Props) => {
  ...
  let secondary = [
    { name: '添加商品', icon: 'icon-home', url: '/' },
    { name: '商品分类', icon: 'icon-home', url: '/' },
    { name: '商品模型', icon: 'icon-home', url: '/' },
    { name: '商品规格', icon: 'icon-home', url: '/' },
    { name: '商品参数', icon: 'icon-home', url: '/' },
    { name: '规格参数', icon: 'icon-home', url: '/' },
  ]
  let toggle = () => {
