...
let RotationChart = () => {
    ...
    return (
        <div style={{ backgroundColor: '#fff', width: '100%', height: '100%', padding: 20 }}>
            ...
            <div>
                <Table dataSource={topics.data && topics.data}>
                    <Column
                        title="图片"
                        dataIndex="link"
                        key="tags"
                    ...
                    />
                    <Column title="路径" dataIndex="url" key="lastName" />
                    <Column title="标题" dataIndex="title" key="age" />
                    <Column title="链接" dataIndex="link" key="address" />
                    <Column
                        title="是否显示"
                        dataIndex="isShow"
                        key="tags"
