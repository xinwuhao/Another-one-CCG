                            ...
                            titleRender={(item) => {
                                return (
                                    <div style={{
                                        ...
                                        <div style={{ position: 'absolute', right: 10, display: 'flex' }} className={'enter'}>
                                            <div style={{ marginRight: 10, display: 'none' }}>新增</div>
                                            <div style={{ marginRight: 10, display: 'none' }}>禁用</div>
                                            <div style={{ display: 'none' }}>删除</div>
                                        </div>
                                    </div>
                                )
                            }}
