                                ...
                                return (
                                    <div className={`${styles.box}`}>
                                        ...
                                        <div style={{ position: 'absolute', right: 10, display: 'flex' }}>
                                            <div className={`${styles.box1}`} style={{ marginLeft: 10, fontWeight: 700 }}>新增</div>
                                            <div className={`${styles.box1}`} style={{ marginLeft: 10, fontWeight: 700 }}>禁用</div>
                                            <div className={`${styles.box1}`} style={{ marginLeft: 10, fontWeight: 700 }}>删除</div>
                                        </div>
                                    </div>
                                )
                            }}
