        ...
        <div style={{ width: "100%", backgroundColor: 'white', padding: 10 }}>
            ...
            <div>
                <Table dataSource={topics.data} rowKey='_id'>
                    ...
                    <Column title="模型名称" dataIndex="name" key="name" width={150} />
                    <Column title="所属模型" dataIndex="name" key="name" width={150} />
                    <Column title="展现方式" dataIndex="name" key="name" width={150} />
                    <Column title="规格项" dataIndex="name" key="name" />
                    <Column
                        title="操作"
                        key="action"
                        width={200}
