...
const Sparameters = () => {
    ...
    let specParasInfo = useSelector((state: any) => state.Spara.list.data)
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ backgroundColor: '#fff', width: '100%', height: '100%', padding: 20 ,zIndex:9999999999999}}>
            ...
            <div>
                <div id="div1" style={{ zIndex: 0 }}>
                    <p dangerouslySetInnerHTML={{ __html: specParasInfo }}></p>
                </div>
                <Button type="primary" htmlType="submit"
                    style={{ position: 'absolute', right: 40, marginTop: 10 }}
                    onClick={onFinish}
                >确定</Button>
            </div>
        </div>
