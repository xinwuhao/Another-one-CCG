        ...
        <div style={{ width: '100%', backgroundColor: 'white', padding: 10 }}>
            ...
            <div>
                <Table dataSource={topics.data} rowKey='_id'>
                    ...
                    <Column title="商品名称"  width={300} dataIndex="content" key="content" />
                    <Column title="商品原价" dataIndex="content" key="content" />
                    <Column title="商品现价" dataIndex="content" key="content" />
                    <Column title="商品库存" dataIndex="content" key="content" />
                    <Column title="是否新品" dataIndex="content" key="content" />
                    <Column title="是否热卖" dataIndex="content" key="content" />
                    <Column title="是否推荐" dataIndex="content" key="content" />
                    <Column
                        title="上下架"
                        dataIndex="isShow"
