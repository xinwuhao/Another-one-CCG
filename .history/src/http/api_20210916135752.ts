...
export default {
  ...
  // 修改秒杀
  updateSeckill({ start_time, end_time, goods_number, goods, isShow, id }: { id: any, start_time: string, end_time: string, goods_number: string, goods: string, isShow: boolean }) {
