...
export default {
  ...
  // 修改商品参数
  updateParams({ id, parentId, url, name, desc }: { id: string, parentId: string, url: string, name: string, desc: string }) {
  ...
  // 修改秒杀
  updateSeckill({ start_time, end_time, goods_number, goods, isShow, id, price }: { price: any, id: any, start_time: string, end_time: string, goods_number: string, goods: string, isShow: boolean }) {
  ...
  updateCoupon({ id, name, amount, threshold, start_time, end_time, number, isShow }: { id: string, name: string, amount: string, threshold: string, start_time: string, end_time: string, number: string, isShow: boolean }) {
